        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="space-y-8">
            ...
            <div className="p-8 rounded-lg bg-blue-100/30">
              ...
              <p className="text-gray-900 text-lg font-bold">My close-up magic is perfect for cocktail hours, dinner parties, corporate networking events, and private celebrations. It enhances both formal and casual gatherings by sparking conversation and delighting guests.</p>
            </div>
            <div className="p-8 rounded-lg bg-blue-100/30">
