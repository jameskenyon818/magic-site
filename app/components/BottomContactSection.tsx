          ...
          >
            <div>
              ...
              <input
                ...
                name="name"
                required
                className="w-full px-3 py-2 border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white/10 text-white backdrop-blur-sm"
              />
            </div>

            <div>
              <label htmlFor="company" className="block text-sm font-medium text-white mb-1">Company</label>
              <input
                type="text"
                id="company"
                name="company"
            ...
            <div>
              <label htmlFor="eventDate" className="block text-sm font-medium text-white mb-1">Event Date</label>
              <input
                type="date"
                id="eventDate"
                name="eventDate"
            ...
            <div>
              <label htmlFor="budgetRange" className="block text-sm font-medium text-white mb-1">Budget Range</label>
              <select
                id="budgetRange"
                name="budgetRange"
                className="w-full px-3 py-2 border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white/10 text-white backdrop-blur-sm"
            ...
            <div>
              <label htmlFor="guestCount" className="block text-sm font-medium text-white mb-1">Number of Guests</label>
              <select
                id="guestCount"
                name="guestCount"
                className="w-full px-3 py-2 border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white/10 text-white backdrop-blur-sm"
            ...
            <div className="md:col-span-2">
              <label htmlFor="additionalDetails" className="block text-sm font-medium text-white mb-1">Additional Details</label>
              <textarea
            ...
            <div className="md:col-span-2 text-center">
              <button
                type="submit"
                className="px-8 py-3 bg-white/10 text-white font-semibold rounded-md hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 transition-colors border border-white/30 backdrop-blur-sm"
              >
