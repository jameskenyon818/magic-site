    ...
    <>
      <main className="min-h-screen bg-black text-white">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg mb-6 text-gray-300">
                  ...
                  Austin, James adapts his performance to match your event's atmosphere and goals.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-300">James creates intimate moments of wonder that connect with your guests on a personal level, making your Austin event truly memorable.</p>
              </div>
              <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
        ...
        <section className="py-16 bg-black">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-white">
              Close-Up Magic Success Stories in Austin
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-zinc-900 p-6 rounded-lg">
                <p className="text-gray-300 italic mb-4">
                  "James worked the room perfectly at our corporate event in Austin. Every guest felt special and engaged."
                </p>
                <p className="font-semibold text-white">— Tech Company CEO</p>
              </div>
              <div className="bg-zinc-900 p-6 rounded-lg">
                <p className="text-gray-300 italic mb-4">
                  "The close-up magic was the highlight of our wedding reception at the Austin venue. Guests are still talking about it!"
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
                ...
                <Link href="/cities/austin-magician/stage-magic" className="text-blue-400 hover:text-blue-300">Learn More →</Link>
              </div>
              <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
