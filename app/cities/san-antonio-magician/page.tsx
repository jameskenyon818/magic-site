  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-black text-white">
        ...
        {/* Rest of the sections remain the same as Houston page */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
                ...
                <p className="italic text-white mb-6">"James's trade show magic increased our booth traffic by 40% and helped us generate more leads than any other show we've attended."</p>
                <div className="font-bold text-white">Marcus Chen</div>
                <div className="text-gray-400 text-sm">Sales Director, TechVision Inc.</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="w-full relative py-28 px-4 min-h-[1100px] flex items-center justify-center">
          ...
          <div className="relative z-20 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            ...
            {/* Right: Contact Form */}
            <div className="rounded-2xl p-8 md:p-12 flex flex-col justify-center">
