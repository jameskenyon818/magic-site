    ...
    <main className="min-h-screen">
        ...
        <div className="relative z-10 h-[calc(100vh-4rem)] flex flex-col items-center justify-start text-white text-center px-4 pt-24">
          <div className="space-y-6 max-w-3xl">
            <div className="inline-block bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">
              Elite Corporate Entertainment in Los Angeles
            </div>
            <h1 className="text-5xl md:text-6xl font-bold leading-tight drop-shadow-lg">
              Los Angeles's Premier Corporate Magician
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 drop-shadow-md mt-12">
              Elevate your Los Angeles corporate events with world-class entertainment that leaves a lasting impression
            </p>
            <div className="pt-8">
              <Link 
                href="#contact"
      ...
      <section id="performances" className="w-full bg-black py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
            Tailored magical experiences for every Los Angeles occasion
          </h2>
          <p className="text-lg md:text-xl text-gray-400 text-center mb-12 max-w-3xl mx-auto">
            From intimate executive dinners to large-scale conferences, James offers customized performances to suit your Los Angeles event needs.
          </p>
          {/* Images Row */}
      ...
      <section className="w-full bg-black py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-16 max-w-2xl mx-auto">From initial inquiry to post-event follow-up, we ensure a professional and straightforward process for your Los Angeles event.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center bg-[#181818] rounded-2xl p-8 shadow-lg">
              ...
              <div className="text-gray-300 text-base">We'll discuss your Los Angeles event objectives, audience, and specific requirements to determine the perfect magical experience.</div>
            </div>
      ...
      <section id="clients" className="w-full bg-black py-20 px-4">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 text-center mb-10 max-w-2xl">James has performed for some of the world's most recognizable brands and at exclusive corporate events in Los Angeles.</p>
      ...
      <section id="testimonials" className="w-full bg-black py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-12">
            What Los Angeles clients say about James
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
              ...
              <p className="italic text-white mb-6">"James's magic made our Los Angeles gala unforgettable. Our guests are still talking about it!"</p>
              <div className="font-bold text-white">Jessica Kim</div>
              <div className="text-gray-400 text-sm">Event Coordinator, LA Elite Events</div>
            </div>
            {/* Testimonial 2 */}
            <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
              <div className="flex mb-4">{Array(5).fill(0).map((_, i) => (<span key={i} className="text-white text-xl">★</span>))}</div>
              <p className="italic text-white mb-6">"We've hosted many events in Los Angeles, but James brought a level of sophistication and fun that was unmatched."</p>
      ...
      <section id="about" className="relative w-full min-h-[480px] bg-black py-20 flex items-center justify-center" style={{ backgroundImage: "url('/images/image about.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center text-white px-4 pt-80 pb-12 flex flex-col items-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-10">
            With over a decade of experience performing for Fortune 500 companies and at Los Angeles's most prestigious events, James Kenyon is the top choice for corporate entertainment in Los Angeles. His unique style and engaging presence make every Los Angeles event unforgettable.
          </p>
        </div>
      </section>
      ...
      <section id="contact" className="w-full relative py-28 px-4 min-h-[1100px] flex items-center justify-center">
        ...
        <div className="relative z-20 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="flex flex-col items-center justify-center text-center md:text-left px-8 py-20">
            ...
            <p className="text-2xl md:text-3xl text-gray-200 mb-10">Contact us today to check availability for your upcoming Los Angeles event and discover how James can create an unforgettable experience.</p>
