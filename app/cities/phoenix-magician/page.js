...
export default function PhoenixMagicianPage() {
  return (
    <>
      <SmoothScroll />
      <Head>
        <title>Phoenix Magician | James Kenyon - Corporate Magic in Phoenix</title>
        <meta name="description" content="Bring world-class magic to your Phoenix event with James Kenyon, the premier Phoenix magician for corporate events, galas, and private parties." />
      </Head>
      <main className="min-h-screen">
          ...
          <div className="relative z-10 h-[calc(100vh-4rem)] flex flex-col items-center justify-start text-white text-center px-4 pt-24">
            <div className="space-y-6 max-w-3xl">
              ...
              <h1 className="text-5xl md:text-6xl font-bold leading-tight drop-shadow-lg">
                Phoenix's Premier Magician for Events & Trade Shows
              </h1>
              <p className="text-xl md:text-2xl text-gray-200 drop-shadow-md mt-12">
                Phoenix is known for its stunning desert landscapes and thriving business community. James Kenyon brings world-class magic to the city's most exclusive events, from downtown to the desert resorts. Experience a show that will leave your guests talking long after your Phoenix event ends.
              </p>
              <div className="pt-8">
                <Link 
                  href="#contact"
        ...
        <section id="about" className="relative w-full min-h-[480px] bg-black py-20 flex items-center justify-center" style={{ backgroundImage: "url('/images/image about.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center text-white px-4 pt-80 pb-12 flex flex-col items-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-10">
              With over a decade of experience performing for Fortune 500 companies and at Phoenix's most prestigious events, James Kenyon is the top choice for corporate entertainment in Phoenix. His unique style and engaging presence make every Phoenix event unforgettable.
            </p>
          </div>
        </section>
        ...
        <section id="performances" className="w-full bg-black py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
              Tailored magical experiences for every Phoenix occasion
            </h2>
            <p className="text-lg md:text-xl text-gray-400 text-center mb-12 max-w-3xl mx-auto">
              From executive dinners to large-scale conferences, James offers customized performances to suit your Phoenix event needs.
            </p>
            {/* Images Row */}
        ...
        <section id="testimonials" className="w-full bg-black py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-12">
              What Phoenix clients say about James
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
                ...
                <p className="italic text-white mb-6">"James's magic made our Phoenix gala unforgettable. Our guests are still talking about it!"</p>
                <div className="font-bold text-white">Emily Johnson</div>
                <div className="text-gray-400 text-sm">Event Coordinator, Phoenix Elite Events</div>
              </div>
              {/* Testimonial 2 */}
              <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
                <div className="flex mb-4">{Array(5).fill(0).map((_, i) => (<span key={i} className="text-white text-xl">★</span>))}</div>
                <p className="italic text-white mb-6">"We've hosted many events in Phoenix, but James brought a level of sophistication and fun that was unmatched."</p>
        ...
        <section className="w-full bg-black py-20 px-4">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Book Phoenix's top magician for your next event</h2>
            <p className="text-lg md:text-xl text-gray-300 mb-16 max-w-2xl mx-auto">Contact James today to check availability for your Phoenix event and discover how he can create an unforgettable experience for your guests.</p>
            <QuoteForm />
          </div>
        </section>
        ...
        <section id="clients" className="w-full bg-black py-20 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
              <img src="/images/clients/amazon.png" alt="Amazon" className="h-12 grayscale hover:grayscale-0 transition-all" />
              <img src="/images/clients/microsoft.png" alt="Microsoft" className="h-12 grayscale hover:grayscale-0 transition-all" />
              <img src="/images/clients/google.png" alt="Google" className="h-12 grayscale hover:grayscale-0 transition-all" />
              <img src="/images/clients/apple.png" alt="Apple" className="h-12 grayscale hover:grayscale-0 transition-all" />
              <img src="/images/clients/facebook.png" alt="Facebook" className="h-12 grayscale hover:grayscale-0 transition-all" />
              <img src="/images/clients/netflix.png" alt="Netflix" className="h-12 grayscale hover:grayscale-0 transition-all" />
              <img src="/images/clients/tesla.png" alt="Tesla" className="h-12 grayscale hover:grayscale-0 transition-all" />
              <img src="/images/clients/uber.png" alt="Uber" className="h-12 grayscale hover:grayscale-0 transition-all" />
            </div>
          </div>
        </section>
