  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-black text-white">
        ...
        <section id="performances" className="w-full bg-black py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
              Tailored magical experiences for every corporate occasion in Phoenix
            </h2>
            <p className="text-lg md:text-xl text-gray-400 text-center mb-12 max-w-3xl mx-auto">
              From intimate executive dinners to large-scale conferences, James offers customized performances to suit your specific event needs in Phoenix.
            </p>
            {/* Images Row */}
        ...
        <section id="contact" className="w-full relative py-16 md:py-28 px-4 min-h-[800px] md:min-h-[1100px] flex items-center justify-center">
          ...
          <div className="relative z-20 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            {/* Left: Prompt */}
            <div className="flex flex-col items-center justify-center text-center md:text-left px-4 md:px-8 py-12 md:py-20">
              <h2 className="text-3xl md:text-6xl font-bold text-white mb-4 md:mb-6">Ready to amaze your guests?</h2>
              <p className="text-xl md:text-3xl text-gray-200 mb-6 md:mb-10">Contact us today to check availability for your upcoming corporate event and discover how James can create an unforgettable experience.</p>
              <div className="flex items-center justify-center md:justify-start text-white text-xl md:text-2xl font-bold gap-3 md:gap-4 bg-black/50 rounded-full px-6 md:px-8 py-3 md:py-4">
