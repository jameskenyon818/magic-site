        ...
        <div className="relative z-10 h-[calc(100vh-4rem)] flex flex-col items-center justify-start text-white text-center px-4 pt-24">
          <div className="space-y-6 max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-bold leading-tight drop-shadow-lg">
              Tampa's Premier Magician for Events & Trade Shows
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 drop-shadow-md mt-12">
              Tampa is known for its vibrant business community and world-class venues. James Kenyon brings world-class magic to the city's most exclusive events, from downtown to the waterfront. Experience a show that will leave your guests talking long after your Tampa event ends.
            </p>
            <div className="pt-8">
              <Link 
                href="#contact"
      ...
      <section id="performances" className="w-full bg-black py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
            Tailored magical experiences for every Tampa occasion
          </h2>
          <p className="text-lg md:text-xl text-gray-400 text-center mb-12 max-w-3xl mx-auto">
            From executive dinners to large-scale conferences, James offers customized performances to suit your Tampa event needs.
          </p>
      ...
      <section id="about" className="relative w-full min-h-[480px] bg-black py-20 flex items-center justify-center" style={{ backgroundImage: "url('/images/image about.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center text-white px-4 pt-80 pb-12 flex flex-col items-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-10">
            With over a decade of experience performing for Fortune 500 companies and at Tampa's most prestigious events, James Kenyon is the top choice for corporate entertainment in Tampa. His unique style and engaging presence make every Tampa event unforgettable.
          </p>
      ...
      <section className="w-full bg-black py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-12">
            What Tampa clients say about James
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
              ...
              <p className="italic text-white mb-6">"James's magic made our Tampa gala unforgettable. Our guests are still talking about it!"</p>
              <div className="font-bold text-white">Sarah Johnson</div>
              <div className="text-gray-400 text-sm">Event Coordinator, Tampa Elite Events</div>
            </div>
            {/* Testimonial 2 */}
            <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
              <div className="flex mb-4">{Array(5).fill(0).map((_, i) => (<span key={i} className="text-white text-xl">★</span>))}</div>
              <p className="italic text-white mb-6">"We've hosted many events in Tampa, but James brought a level of sophistication and fun that was unmatched."</p>
      ...
      <section id="contact" className="w-full relative py-28 px-4 min-h-[1100px] flex items-center justify-center">
        ...
        <div className="relative z-20 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          <div className="flex flex-col items-center justify-center text-center md:text-left px-8 py-20">
            ...
            <p className="text-2xl md:text-3xl text-gray-200 mb-10">Contact us today to check availability for your upcoming Tampa event and discover how James can create an unforgettable experience.</p>
