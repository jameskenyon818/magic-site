...
export const metadata: Metadata = {
  ...
  description: 'Looking for a close-up magician in Miami? James Kenyon delivers intimate, interactive performances that create unforgettable moments at your corporate event or private party in Miami.'
};
