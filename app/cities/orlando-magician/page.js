...
export default function OrlandoMagicianPage() {
  return (
    <>
      <Head>
        <title>Orlando Magician | James Kenyon - Corporate Magic in Orlando</title>
        <meta name="description" content="Bring world-class magic to your Orlando event with James Kenyon, the premier Orlando magician for corporate events, galas, and private parties." />
      </Head>
      <main className="min-h-screen">
          ...
          <div className="relative z-10 h-[calc(100vh-4rem)] flex flex-col items-center justify-start text-white text-center px-4 pt-24">
            <div className="space-y-6 max-w-3xl">
              ...
              <h1 className="text-5xl md:text-6xl font-bold leading-tight drop-shadow-lg">
                Orlando's Premier Magician for Events & Trade Shows
              </h1>
              <p className="text-xl md:text-2xl text-gray-200 drop-shadow-md mt-12">
                Planning an event in Orlando? James Kenyon brings world-class magic to the city's most exclusive venues, from downtown to the theme park district. Experience a show that will leave your guests talking long after your Orlando event ends.
              </p>
              <div className="pt-8">
                <Link 
                  href="#contact"
        ...
        <section id="about" className="relative w-full min-h-[480px] bg-black py-20 flex items-center justify-center" style={{ backgroundImage: "url('/images/image about.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center text-white px-4 pt-80 pb-12 flex flex-col items-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-10">
              With over a decade of experience performing for Fortune 500 companies and at prestigious events worldwide, James Kenyon is the top choice for corporate entertainment in Orlando. His blend of sleight of hand, psychological illusions, and engaging storytelling makes every Orlando event unforgettable.
            </p>
          </div>
        </section>
        ...
        <section id="performances" className="w-full bg-black py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
              Tailored magical experiences for every Orlando occasion
            </h2>
            <p className="text-lg md:text-xl text-gray-400 text-center mb-12 max-w-3xl mx-auto">
              From executive dinners to large-scale conferences, James offers customized performances to suit your Orlando event needs.
            </p>
            {/* Images Row */}
        ...
        <section id="clients" className="w-full bg-black py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-12">
              What Orlando clients say about James
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
                ...
                <p className="italic text-white mb-6">"James's performance was the highlight of our Orlando conference. Our guests were amazed!"</p>
                <div className="font-bold text-white">Ava Martinez</div>
                <div className="text-gray-400 text-sm">Event Planner, Orlando Events Co.</div>
              </div>
              {/* Testimonial 2 */}
              <div className="bg-black rounded-xl border border-gray-800 shadow-lg p-8 flex flex-col items-center text-center">
                <div className="flex mb-4">{Array(5).fill(0).map((_, i) => (<span key={i} className="text-white text-xl">★</span>))}</div>
                <p className="italic text-white mb-6">"We've hosted many events in Orlando, but James brought a level of sophistication and fun that was unmatched."</p>
        ...
        <section className="w-full bg-black py-20 px-4">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Book Orlando's top magician for your next event</h2>
            <p className="text-lg md:text-xl text-gray-300 mb-16 max-w-2xl mx-auto">Contact James today to check availability for your Orlando event and discover how he can create an unforgettable experience for your guests.</p>
            {/* ...booking steps... */}
          </div>
        </section>
