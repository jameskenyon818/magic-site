...
export const metadata: Metadata = {
  title: 'Close-Up Magic in Orlando — Perfect for Corporate Events & Private Parties',
  description: 'Looking for a close-up magician in Orlando? James Kenyon delivers intimate, interactive performances that create unforgettable moments at your corporate event or private party.'
};

export default function OrlandoCloseUpPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center">
        <Image
          ...
          alt="Close-up magic performance in Orlando"
          fill
      ...
      <section className="py-16 px-4 bg-black">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
            Create Unforgettable Moments in Orlando
          </h2>
          <div className="space-y-12">
            <div className="flex items-start space-x-6">
              ...
              <p className="text-xl text-gray-200">Experience magic up close and personal in Orlando, where every trick happens right in front of your eyes. Perfect for cocktail hours, dinner parties, and corporate networking events in Orlando, creating natural conversation starters and memorable interactions.</p>
            </div>
            <div className="flex items-start space-x-6">
              <div className="flex-shrink-0 w-8 h-8 mt-1">
                <svg className="w-8 h-8 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-xl text-gray-200">Each performance in Orlando is tailored to your event's atmosphere and audience, whether it's sophisticated corporate entertainment or engaging party magic. The intimate nature of close-up magic creates a unique connection with your guests.</p>
            </div>
            <div className="flex items-start space-x-6">
              <div className="flex-shrink-0 w-8 h-8 mt-1">
                <svg className="w-8 h-8 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-xl text-gray-200">From elegant card tricks to mind-bending mentalism, each effect is carefully selected to amaze and entertain your Orlando audience. The performance flows naturally through your event, creating a sophisticated atmosphere that enhances the overall experience.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-black bg-blue-100/30 p-4 rounded-lg">
            Frequently Asked Questions About Close-Up Magic in Orlando
          </h2>
          <div className="space-y-8">
            <div className="p-8 rounded-lg bg-blue-100/30">
              <h3 className="text-xl font-bold mb-4 text-black">What is close-up magic?</h3>
              <p className="text-gray-900 text-lg font-bold">Close-up magic is performed right in front of your guests, often using everyday objects like cards, coins, or borrowed items. It creates a personal and interactive experience where the magic happens literally in the palm of your hand, leaving guests amazed and engaged. As your Orlando magician, I specialize in making these moments unforgettable.</p>
            </div>
            <div className="p-8 rounded-lg bg-blue-100/30">
            ...
            <div className="p-8 rounded-lg bg-blue-100/30">
              ...
              <p className="text-gray-900 text-lg font-bold">My close-up magic is perfect for cocktail hours, dinner parties, corporate networking events, and private celebrations in Orlando. It enhances both formal and casual gatherings by sparking conversation and delighting guests.</p>
            </div>
            <div className="p-8 rounded-lg bg-blue-100/30">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-black p-8 rounded-lg border border-gray-800">
              <p className="text-gray-300 mb-6 text-lg">"James's close-up magic was the highlight of our corporate dinner in Orlando. He moved seamlessly between tables, creating intimate moments of wonder that brought our team together in a unique way."</p>
              <div>
            ...
            <div className="bg-black p-8 rounded-lg border border-gray-800">
              <p className="text-gray-300 mb-6 text-lg">"The way James engaged with our guests was remarkable. His close-up magic created the perfect atmosphere for our networking event in Orlando, making it easy for people to connect and share their amazement."</p>
              <div>
            ...
            <div className="bg-black p-8 rounded-lg border border-gray-800">
              <p className="text-gray-300 mb-6 text-lg">"Our holiday party in Orlando was transformed by James's performance. The intimate nature of close-up magic made everyone feel special, and the reactions were priceless. It was exactly what we needed to make our event memorable."</p>
              <div>
            ...
            <div className="bg-black p-8 rounded-lg border border-gray-800">
              <p className="text-gray-300 mb-6 text-lg">"James's ability to read the room and adapt his performance to different groups was impressive. He created a sophisticated atmosphere that perfectly complemented our corporate event in Orlando."</p>
              <div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="flex flex-col items-center bg-[#181818] rounded-2xl p-8 shadow-lg">
              ...
              <div className="text-gray-300 text-base">We'll discuss your event objectives, audience, and specific requirements to determine the perfect magical experience for your Orlando event.</div>
            </div>
            ...
            <div className="flex flex-col items-center bg-[#181818] rounded-2xl p-8 shadow-lg">
              ...
              <div className="text-gray-300 text-base">James will design a tailored performance that incorporates your brand messaging and aligns with your Orlando event goals.</div>
            </div>
            {/* Step 3: Performance */}
            <div className="flex flex-col items-center bg-[#181818] rounded-2xl p-8 shadow-lg">
              {/* Icon */}
              ...
              <div className="text-gray-300 text-base">James delivers a flawless, memorable experience that exceeds expectations and achieves your Orlando event goals.</div>
            </div>
          </div>
        </div>
      </section>
