...
export const metadata = {
  title: 'Stage Magician in Dallas — Big Magic for Large Audiences',
  description: 'Looking for a stage magician in Dallas? James Kenyon delivers captivating stage shows for weddings, galas, and large corporate events. Book now for an unforgettable performance.',
};
        ...
        <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center">
          <div className="absolute inset-0">
            <Image
              ...
              alt="Stage magic performance in Dallas"
              fill
          ...
          <div className="relative z-10 text-center text-white px-4">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Stage Magician in Dallas
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Captivating stage shows that transform your Dallas event into an unforgettable experience
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Stage Magic in Dallas: Perfect for Large Events
            </h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-lg mb-6">
                  When you need a stage magician in Dallas for your large event, James Kenyon delivers 
                  performances that captivate audiences of all sizes. From elegant Dallas weddings to 
                  corporate galas, our stage shows create moments of wonder that your guests will never forget.
                </p>
                <p className="text-lg mb-6">
                  Dallas's vibrant event scene deserves entertainment that matches its energy. Our stage 
                  magic performances combine classic illusions with modern presentation, perfect for the 
                  city's diverse venues and audiences.
                </p>
                <p className="text-lg">
                  Whether you're planning a wedding at one of Dallas's historic venues or a corporate 
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <Link href="/cities/dallas-magician/close-up" className="text-blue-600 hover:text-blue-800">Learn More →</Link>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
