        ...
        <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center">
          <div className="absolute inset-0">
            <Image
              ...
              alt="Trade show magic performance in Dallas"
              fill
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Trade Show Magic in Dallas: Drive Booth Traffic
            </h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-lg mb-6">
                  When you need to stand out at Dallas's busy trade shows and conferences, a trade show 
                ...
                <p className="text-lg mb-6">
                  Dallas's tech and business events are known for innovation and creativity. Our trade show 
                ...
                <p className="text-lg">
                  From the Dallas Convention Center to corporate events across the city, our trade show 
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 italic mb-4">
                  "James helped us triple our booth traffic in Dallas. He worked our product message into the magic and made us the talk of the show."
                </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 italic mb-4">
                  "Our team loved him. Our clients remembered us. And yes — we already booked him for next year's Dallas convention."
                </p>
